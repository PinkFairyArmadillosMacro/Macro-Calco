...
const RecipeTemplate = (props) => {
  ...
  const {label, calories, protein, carbs, fat, image, healthLabels, dietLabels, cautions, shareAs} = props.recipeInfo
  ...
  */
  ...
  return (
    <div className="recipe-template-container">
      ...
      <img alt='IMAGE' className="recipe-image" onClick={() => window.open(shareAs, "_blank")} height='200' width='200' src={image} />
