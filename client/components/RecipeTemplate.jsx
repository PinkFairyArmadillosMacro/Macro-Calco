...
const RecipeTemplate = (props) => {
  ...
  return (
    <div className="recipe-template-container">
      <h2 id='recipe-template-title'>Recipe Name</h2>
          ...
          <div id="nutrition-facts-columns-container">
            ...
            <div id="nutrition-column-two">
              ...
              <div className="nutrition-facts-label-container single-serv-label">
                <p className="nutrition-facts-label">10g</p>
                <p className="nutrition-facts-label">20g</p>
                <p className="nutrition-facts-label">30g</p>
              </div>
            </div>
            <div id="nutrition-column-three">
              ...
              <div className="nutrition-facts-label-container recipe-serv-label">
                <p className="nutrition-facts-label">20g</p>
                <p className="nutrition-facts-label">40g</p>
                <p className="nutrition-facts-label">60g</p>
              </div>
            </div>
          </div>
          <div id="nutrition-health-labels-container">
            <p>*Health Labels: high protein, low carb, low fat, gluten-free, dairy-free, peanut-free</p>
          </div>
        </div>
          <h1 className='pie-chart-text'>O</h1>
       
        </div>
  
      </div>
      <div className="recipe-crud-buttons">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#40513B" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
