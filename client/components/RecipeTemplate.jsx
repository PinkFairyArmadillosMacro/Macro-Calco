...
const RecipeTemplate = (props) => {
  ...
  const {label, cal, protein, carbs, fat, imageURL} = props.recipeInfo;
  const noOfServings = props.recipeInfo.yield;
  //const {label, yield, calories, protein, carbs, fat, image, healthLabels, dietLabels, cautions, shareAs} = props.recipeInfo
  ...
  */
  ...
  const handleClick = (e) =>{
    setCurrentCollection({
      ...
      totalCalories:  totalCalories +  (Math.floor(cal/noOfServings)* desiredServings),
      recipes: recipes.concat({label, noOfServings:desiredServings, cal: (Math.floor(cal/noOfServings)* desiredServings), protein: (Math.floor(protein/noOfServings)* desiredServings), carbs:(Math.floor(carbs/noOfServings)* desiredServings), fat: (Math.floor(fat/noOfServings)* desiredServings)})
    })
